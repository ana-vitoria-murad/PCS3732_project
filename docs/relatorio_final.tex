...
executável, documentação no README e histórico no Git. Foram preparadas três
releases intermediárias e uma release final. O repositório público está disponível em
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{C{2.6cm} p{2.4cm} Y}
        ...
        \midrule
        \shortstack{Semana 1\\v0.1.0} & Estruturação & Captura, inspeção de áudio,
        utilitários, espectrograma e banco inicial.\\
        \shortstack{Semana 2\\v0.2.0} & Pipeline completo & Cadastro automático, novas
        músicas, matching, resultados iniciais e documentação.\\
        \shortstack{Semana 3\\v0.3.0} & Integração & Interface web, protótipo visual,
        GPIO e evidências em vídeo.\\
